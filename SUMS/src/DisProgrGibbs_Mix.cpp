...
List DisProgrGibbs_Mix(List MCMC_input){
  ...
  if(impute_missing_Y){
    if(impute_missing_H){
      return List::create(Named("Graph_List") = Graph_List, Named("mu_out") = mu_out, Named("m_mu_out") = m_mu_out, Named("k0_out") = k0_out, Named("phi_star_out") = phi_star_out, Named("S_m_out") = S_m_out, Named("c_out") = c_out, Named("u_out") = u_out, Named("K_N_out") = K_N_out, Named("M_out") = M_out, Named("gamma_S_out") = gamma_S_out, Named("Lambda_out") = Lambda_out, Named("XZ_List") = XZ_List, Named("Binder_List") = Binder_List, Named("Y_out") = Y_out, Named("H_out") = H_out);
    }else{
      return List::create(Named("Graph_List") = Graph_List, Named("mu_out") = mu_out, Named("m_mu_out") = m_mu_out, Named("k0_out") = k0_out, Named("phi_star_out") = phi_star_out, Named("S_m_out") = S_m_out, Named("c_out") = c_out, Named("u_out") = u_out, Named("K_N_out") = K_N_out, Named("M_out") = M_out, Named("gamma_S_out") = gamma_S_out, Named("Lambda_out") = Lambda_out, Named("XZ_List") = XZ_List, Named("Binder_List") = Binder_List, Named("Y_out") = Y_out);
    }
  }else{
    if(impute_missing_H){
      return List::create(Named("Graph_List") = Graph_List, Named("mu_out") = mu_out, Named("m_mu_out") = m_mu_out, Named("k0_out") = k0_out, Named("phi_star_out") = phi_star_out, Named("S_m_out") = S_m_out, Named("c_out") = c_out, Named("u_out") = u_out, Named("K_N_out") = K_N_out, Named("M_out") = M_out, Named("gamma_S_out") = gamma_S_out, Named("Lambda_out") = Lambda_out, Named("XZ_List") = XZ_List, Named("Binder_List") = Binder_List, Named("H_out") = H_out);
    }else{
      return List::create(Named("Graph_List") = Graph_List, Named("mu_out") = mu_out, Named("m_mu_out") = m_mu_out, Named("k0_out") = k0_out, Named("phi_star_out") = phi_star_out, Named("S_m_out") = S_m_out, Named("c_out") = c_out, Named("u_out") = u_out, Named("K_N_out") = K_N_out, Named("M_out") = M_out, Named("gamma_S_out") = gamma_S_out, Named("Lambda_out") = Lambda_out, Named("XZ_List") = XZ_List, Named("Binder_List") = Binder_List);
    }
  }
}
